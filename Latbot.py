...
TOKEN = "8442102777:AAFQd3FDMTwXkwI4mq5X_vjywPty0aqPICU"  
...
def send_welcome(message):
    bot.reply_to(message, "Hlo 😁 Me @Obitopy ka bot hu mujhe use krne ke lie liye /reset <username ya email> daalo Fast😎.")
